			...
			<?php
				...
				if ($result->num_rows > 0) {
					...
					while($row = $result->fetch_assoc()) {
						...
						echo "<hr/>";
						echo "</tr>";
					echo "	<td><a href='editproduct.php?id=$row[id]&name=$row[name]&quantity=$row[quantity]&description=$row[description]'>Edit</a> </br><a href='deleteproduct.php?id=$row[id]&name=$row[name]&quantity=$row[quantity]&description=$row[description]'>Delete</a></td>";
